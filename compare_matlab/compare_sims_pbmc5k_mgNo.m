...
% figTablesDir = 'FigTables/Sims-humanCR300-pbmc5k-MultiGeneNo/';
% savePrefix = [ figTablesDir ];
% load([savePrefix 'Res.mat'])%, 'caseTable1', 'RD', 'MARD', 'corrGenesCells', 'corrCells');

%% cases
genome1='human_CR_3.0.0';  sample1='pbmc_5k_sims_MultiGeneNo'; run1='/20/run3/'; sampleType='/10X/3/'; opt_STAR={}; opt_alevinFry='';
figTablesDir = 'FigTables/Sims-humanCR300-pbmc5k-MultiGeneNo/';
...
corrTruth = corrGenesCells(vSelect(1), vSelect(2:end), 2);
funPlotSpearmanBar(corrTruth, casesSelectNamesShort(end:-1:2), 0.7, savePrefix, compareReference);
